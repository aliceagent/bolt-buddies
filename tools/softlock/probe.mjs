...
export const LEVEL_INDEX = {
  "1-1": 0, "1-2": 1, "1-3": 2, "2-1": 3, "2-2": 4, "2-3": 5, "3-1": 6, "3-2": 7, "3-3": 8, "4-1": 9, tut: 12,
};

// Assignment A: P1 takes the first (grapple/phase/magnet/freeze) pedestal. Roles
// are abstract; the softlock escapes we test are role-symmetric where it matters
...
export const ROLES_A = { G: 0, H: 1, P: 0, T: 1, M: 0, B: 1, F: 0 };
